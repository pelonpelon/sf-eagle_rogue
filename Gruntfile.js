// Generated on 2014-05-10 using generator-php 0.4.0
'use strict';
...
module.exports = function (grunt) {
    ...
    var yeomanConfig = {
        app: 'app',
        dist: 'dist',
        siteURL: 'http://sf-eagle.com/rogue',
        devURL: 'localhost',
        devPort: 80
    };
    ...
    grunt.initConfig({
        ...
        //  to them.
        clean: {
            server: {     // For the "server" task, we only need to clean the .tmp folder.
                files: [{
                    dot: true,
                    src: [
                        '.tmp',
                        '<%= yeoman.app %>/_/css/**/*.{css,map}'
                    ]
                }]
            },
        ...
        usemin: {
            ...
            html: [
                '<%= yeoman.dist %>/_/inc/**/*{.html,.php}',
                '<%= yeoman.dist %>/*{.html,.php}'
            ],
